	...
	public void sceneExitAction(BaseCharacter playerOne) {
		...
		case "A": {
			...
			if (playerOne.getAgility() > 10) {
				...
				System.out.println("You notice the head of small teddybear tilt off to the side. A key is there"
		...
		case "B": {
			...
			if (playerOne.getIntelligence() > 10) {
				...
				System.out.println("At first, it looks like the table is scratched, but after a few seconds, "
		...
		case "C": {
			...
			if (playerOne.getStrength() > 10) {
				System.out.println("Something inhuman charges at you: You react half in fear, half on instinct, "
				...
				System.out.println("As you get closer to the closet, you hear guttural sounds from within. "
		...
		default: {
			...
			if (playerOne.getStrength() > 10) {
				...
				System.out.println("As you get closer to the closet, you hear guttural sounds from within. You "
