...
public class OpeningScene extends BaseScene {
	...
	public OpeningScene() {
		...
		this.eventOptions = new String[] {"A. You try to finesse your way out of the bonds.\n" 
	...
	public void sceneExitAction(BaseCharacter playerOne) {
		...
		case "A": {
			...
			if(playerOne.getAgility() > 8 || playerOne.getIntelligence() > 8) {
				...
				playerOne.gainLevel();
				//TODO use a helper function to determine this message based on hp <= 0 or still alive
